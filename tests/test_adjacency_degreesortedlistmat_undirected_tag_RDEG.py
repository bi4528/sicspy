...
g_base = read_amalfi("adjacency_listmat", "undirected_tag", repr(os.path.join(head, "si2_b03_m200.A00")).strip("'"))
h_base = read_amalfi("adjacency_listmat", "undirected_tag", repr(os.path.join(head, "si2_b03_m200.B00")).strip("'"))
g = Graph("adjacency_degreesortedlistmat", "undirected_tag", graph=g_base)
h = Graph("adjacency_degreesortedlistmat", "undirected_tag", graph=h_base)
s = SicsAlgorithms("adjacency_degreesortedlistmat", "undirected_tag")
