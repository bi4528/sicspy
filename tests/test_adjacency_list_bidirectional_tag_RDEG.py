...
g = read_amalfi("adjacency_list", "bidirectional_tag", repr(os.path.join(head, "si2_b03_m200.A00")).strip("'"))
h = read_amalfi("adjacency_list", "bidirectional_tag", repr(os.path.join(head, "si2_b03_m200.B00")).strip("'"))
s = SicsAlgorithms("adjacency_list", "bidirectional_tag")
