...
g = read_amalfi("adjacency_listmat", "undirected_tag", repr(os.path.join(head, "si2_b03_m200.A00")).strip("'"))
h = read_amalfi("adjacency_listmat", "undirected_tag", repr(os.path.join(head, "si2_b03_m200.B00")).strip("'"))
